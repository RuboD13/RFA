...
export function OperationalContext() {
  return (
    <section className="relative py-16 sm:py-20 lg:py-32 bg-[#0a0a0a] overflow-hidden border-b border-white/10">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        {/* Header */}
        <div className="max-w-6xl mx-auto mb-12 sm:mb-16 lg:mb-32">
          <div className="text-center mb-12 sm:mb-16">
            <div className="inline-flex items-center rounded-full border border-white/10 bg-white/[0.03] px-4 py-1.5 text-xs sm:text-sm font-medium text-white/70 mb-6 sm:mb-8 shadow-[0_0_15px_rgba(255,255,255,0.05)] backdrop-blur-sm">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white text-balance tracking-tight mb-5 sm:mb-6 leading-[1.05]">
              Gestionar alquileres <br className="hidden sm:block" /><span className="text-white/40">puede convertirse en un caos</span>
            </h2>
            <p className="text-base sm:text-xl text-white/60 max-w-2xl mx-auto leading-relaxed text-pretty">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-stretch">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-[#111111] p-6 sm:p-8 lg:p-10 group transition-colors duration-500 hover:bg-[#151515]">
              ...
              <div className="relative z-10 h-full flex flex-col justify-center">
                ...
                <ul className="space-y-4 sm:space-y-5 flex-1 flex flex-col justify-center">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-4 text-sm sm:text-base text-white/60 leading-relaxed">
            ...
            {/* Con RentAFlow */}
            <div className="relative overflow-hidden rounded-3xl border border-emerald-500/20 bg-gradient-to-b from-emerald-500/[0.05] to-transparent p-6 sm:p-8 lg:p-10 group transition-all duration-500 hover:border-emerald-500/40 hover:bg-emerald-500/[0.08]">
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className="flex items-center gap-4 mb-6 sm:mb-8">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">Con RentAFlow</h3>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-500 flex flex-col">
            ...
            <div className="relative p-6 sm:p-8 flex-1 flex flex-col">
              <div className="mb-6 sm:mb-8">
                ...
                <h3 className="text-xl sm:text-2xl font-semibold text-white mb-3 tracking-tight">WhatsApp en piloto automático</h3>
          ...
          <div className="hidden md:flex md:row-span-2 group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-500 flex-col">
          ...
          <div className="hidden md:block md:col-span-2 group relative overflow-hidden rounded-3xl bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-500">
